...
export const attentionIsNotTheSameAsDemand: BlogPost = {
  id: 'marketing-01',

  slug: 'attention-is-not-the-same-as-demand',
  ...
  cover:
    '/images/blog/attention-is-not-the-same-as-demand.jpg',
  ...
  content: [
    ...
    {
      type: 'heading',
      text: 'Attention is a signal, not the outcome',
    },
    ...
    {
      type: 'heading',
      text: 'Not all attention comes from the right people',
    },
...

    {
      type: 'list',
      items: [
        'High views can come from people outside the target market.',
        'Shares may reflect entertainment value rather than buying intent.',
        'Comments may indicate interest in the topic rather than interest in the company.',
        'Traffic can increase without improving conversion.',
        'Follower growth can create an audience that is difficult to monetize later.',
      ],
    },

    {
      type: 'heading',
      text: 'Demand begins with a problem that matters',
    },
    ...
    {
      type: 'heading',
      text: 'Strong marketing connects attention to a reason to care',
    },
...

    {
      type: 'list',
      items: [
        'Does the audience recognize the problem being described?',
        'Does the message make the stakes feel relevant?',
        'Does the offer appear credible as a solution?',
        'Is there a clear reason to act now rather than later?',
        'Does the campaign create interest that can continue after the initial impression?',
      ],
    },

    {
      type: 'heading',
      text: 'Reach is not the same as relevance',
    },
    ...
    {
      type: 'heading',
      text: 'The metrics you choose shape the behavior of the marketing team',
    },
    ...
    {
      type: 'heading',
      text: 'Demand often reveals itself through behavior',
    },
...

    {
      type: 'list',
      items: [
        'Repeat visits from the same audience.',
        'Higher engagement with product or service pages.',
        'Downloads of deeper educational material.',
        'Increased branded search.',
        'More specific sales inquiries.',
        'Shorter gaps between awareness and conversion.',
      ],
    },

    {
      type: 'heading',
      text: 'Brand activity can build future demand',
    },
    ...
    {
      type: 'heading',
      text: 'Memorability needs meaning',
    },
    ...
    {
      type: 'heading',
      text: 'Demand can exist without much visible attention',
    },
    ...
    {
      type: 'heading',
      text: 'The offer matters more than the campaign',
    },
...

    {
      type: 'list',
      items: [
        'Is the problem important enough to create urgency?',
        'Is the value easy to understand?',
        'Does the offer feel meaningfully different from alternatives?',
        'Is the price aligned with perceived value?',
        'Does the buying process introduce unnecessary friction?',
      ],
    },

    {
      type: 'heading',
      text: 'Demand generation and demand capture are different',
    },
    ...
    {
      type: 'heading',
      text: 'Attention without a path forward disappears quickly',
    },
    ...
    {
      type: 'heading',
      text: 'Evaluate quality, not only quantity',
    },
...

    {
      type: 'list',
      items: [
        'Did the campaign attract the intended audience?',
        'Did visitors engage with commercially relevant content?',
        'Did inquiries become more qualified?',
        'Did the message improve understanding of the offer?',
        'Did the campaign create measurable movement toward a business objective?',
      ],
    },

    {
      type: 'heading',
      text: 'Attention works best when it has somewhere useful to go',
    },
