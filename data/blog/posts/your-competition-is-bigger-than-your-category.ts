...
export const yourCompetitionIsBiggerThanYourCategory: BlogPost = {
  id: 'brand-strategy-02',

  slug: 'your-competition-is-bigger-than-your-category',

  title: 'Your Competition Is Bigger Than Your Category',
  ...
  cover:
    '/images/blog/your-competition-is-bigger-than-your-category.jpg',
  ...
  content: [
    ...
    {
      type: 'heading',
      text: 'Customers compare solutions, not category labels',
    },
    ...
    {
      type: 'heading',
      text: 'The decision to do nothing is often a major competitor',
    },
    ...
    {
      type: 'heading',
      text: 'Internal teams can be competitors too',
    },
...

    {
      type: 'list',
      items: [
        'What is easier about choosing us instead of building internally?',
        'What risk do we remove that a DIY approach cannot?',
        'What speed advantage do we provide?',
        'What expertise would take the customer years to develop?',
        'What ongoing complexity does our solution eliminate?',
      ],
    },

    {
      type: 'heading',
      text: 'Different competitors require different arguments',
    },
    ...
    {
      type: 'heading',
      text: 'Category boundaries are becoming less stable',
    },
    ...
    {
      type: 'heading',
      text: 'Customers borrow expectations from other industries',
    },
...

    {
      type: 'list',
      items: [
        'A professional service firm may be judged against the onboarding quality of modern software.',
        'A local retailer may be compared with the convenience of large ecommerce platforms.',
        'A financial service may be evaluated against the clarity of consumer technology brands.',
        'A B2B product may be expected to feel as intuitive as everyday consumer apps.',
      ],
    },

    {
      type: 'heading',
      text: 'Look for the job the customer is trying to accomplish',
    },
    ...
    {
      type: 'heading',
      text: 'The real competitor may solve the problem differently',
    },
    ...
    {
      type: 'heading',
      text: 'Competitive advantage is not the same as feature advantage',
    },
...

    {
      type: 'list',
      items: [
        'A narrower specialization can increase credibility.',
        'A simpler process can reduce buying friction.',
        'A stronger point of view can make the company easier to remember.',
        'Better customer experience can differentiate otherwise similar offers.',
        'A trusted reputation can reduce perceived risk.',
      ],
    },

    {
      type: 'heading',
      text: 'Map alternatives, not just logos',
    },
    ...
    {
      type: 'heading',
      text: 'Positioning becomes stronger when the competitive set becomes clearer',
    },
