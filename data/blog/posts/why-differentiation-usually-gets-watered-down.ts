...
export const whyDifferentiationUsuallyGetsWateredDown: BlogPost = {
  id: 'brand-strategy-03',

  slug: 'why-differentiation-usually-gets-watered-down',

  title: 'Why Differentiation Usually Gets Watered Down',
  ...
  cover:
    '/images/blog/why-differentiation-usually-gets-watered-down.jpg',
  ...
  content: [
    ...
    {
      type: 'heading',
      text: 'Difference is easy until it creates a boundary',
    },
    ...
    {
      type: 'heading',
      text: 'The first draft is often more differentiated than the final one',
    },
    ...
    {
      type: 'heading',
      text: 'Consensus naturally moves toward the middle',
    },
    ...
    {
      type: 'heading',
      text: 'Generic language feels safer because nobody can disagree with it',
    },
...

    {
      ...
      items: [
        ...
        'Customer-focused in what observable way?',
        'Strategic about which kinds of decisions?',
        'Tailored instead of what alternative?',
        'High-quality according to which standard?',
      ],
    },
    ...
    {
      type: 'heading',
      text: 'Differentiation is not necessarily about being completely unique',
    },
...

    {
      type: 'list',
      items: [
        'A familiar service delivered through a distinctive process.',
        'A common capability focused on an unusually specific audience.',
        'A recognizable point of view applied consistently across the business.',
        'A different pricing or delivery model that removes a common frustration.',
        'A combination of expertise competitors rarely bring together.',
      ],
    },

    {
      type: 'heading',
      text: 'Proof matters more than adjectives',
    },
    ...
    {
      type: 'heading',
      text: 'Your business model can differentiate the brand',
    },
    ...
    {
      type: 'heading',
      text: 'Trying to preserve every customer weakens the position',
    },
...

    {
      type: 'list',
      items: [
        'Which customers create the strongest work?',
        'Which relationships are most profitable?',
        'Where does the company have unusual credibility?',
        'Which problems does the team understand better than most?',
        'Which type of work should become a larger part of the business?',
      ],
    },

    {
      type: 'heading',
      text: 'Differentiation should help the business make decisions',
    },
    ...
    {
      type: 'heading',
      text: 'Repetition makes difference more believable',
    },
