...
export const theHiddenCostOfOfferingTooManyServices: BlogPost = {
  id: 'business-02',

  slug: 'the-hidden-cost-of-offering-too-many-services',

  title: 'The Hidden Cost of Offering Too Many Services',
  ...
  cover:
    '/images/blog/the-hidden-cost-of-offering-too-many-services.jpg',
  ...
  content: [
    ...
    {
      type: 'heading',
      text: 'Every service creates more than revenue',
    },
    ...
    {
      type: 'heading',
      text: 'More choice can make buying harder',
    },
...

    {
      type: 'list',
      items: [
        'Similar services begin competing with one another for attention.',
        'Sales conversations require more explanation before reaching the actual problem.',
        'Pricing becomes harder to understand and compare.',
        'The homepage has to communicate more information in the same amount of space.',
        'Customers become less certain about what the business is best known for.',
      ],
    },

    {
      type: 'heading',
      text: 'Capability and offering are not the same thing',
    },
    ...
    {
      type: 'heading',
      text: 'Strong offers create useful boundaries',
    },
    ...
    {
      type: 'heading',
      text: 'Audit the services that deserve to remain',
    },
...

    {
      type: 'list',
      items: [
        'Does this service attract the type of client we want more of?',
        'Does it reinforce what we want the business to be known for?',
        'Is the work profitable after accounting for operational complexity?',
        'Does it naturally lead to other valuable work?',
        'Would removing it make our positioning clearer?',
      ],
    },

    {
      type: 'heading',
      text: 'Growth does not always require expansion',
    },
