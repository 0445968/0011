...
export const whenGrowthStartsDilutingTheBusiness: BlogPost = {
  id: 'business-04',

  slug: 'when-growth-starts-diluting-the-business',

  title: 'When Growth Starts Diluting the Business',
  ...
  cover:
    '/images/blog/when-growth-starts-diluting-the-business.jpg',
  ...
  content: [
    ...
    {
      type: 'heading',
      text: 'Growth introduces pressure to become broader',
    },
    ...
    {
      type: 'heading',
      text: 'The original advantage can disappear quietly',
    },
    ...
    {
      type: 'heading',
      text: 'Revenue can hide strategic weakness',
    },
    ...
    {
      type: 'heading',
      text: 'A strong business needs a center of gravity',
    },
    ...
    {
      type: 'heading',
      text: 'Not every opportunity deserves to become part of the business',
    },
    ...
    {
      type: 'heading',
      text: 'Growth also changes the customer experience',
    },
    ...
    {
      type: 'heading',
      text: 'Protect the parts customers cannot easily replace',
    },
    ...
    {
      type: 'heading',
      text: 'Sometimes the right growth is deeper, not wider',
    },
    ...
    {
      type: 'heading',
      text: 'Clarity should survive scale',
    },
