...
export const aBrandStrategyShouldHelpYouSayNo: BlogPost = {
  id: 'brand-strategy-04',

  slug: 'a-brand-strategy-should-help-you-say-no',

  title: 'A Brand Strategy Should Help You Say No',
  ...
  cover:
    '/images/blog/a-brand-strategy-should-help-you-say-no.jpg',
  ...
  content: [
    ...
    {
      type: 'heading',
      text: 'Strategy becomes valuable when choices become difficult',
    },
...

    {
      type: 'list',
      items: [
        'A priority audience means other audiences are secondary.',
        'A core capability means some services receive less emphasis.',
        'A distinctive point of view means some approaches do not fit.',
        'A chosen market position means certain opportunities may weaken the brand.',
        'A clear personality means not every communication style is appropriate.',
      ],
    },

    {
      type: 'heading',
      text: 'Saying no protects recognition',
    },
    ...
    {
      type: 'heading',
      text: 'A good opportunity can still be the wrong opportunity',
    },
...

    {
      ...
      items: [
        ...
        'Does it bring us closer to the customers we want more of?',
        'Will it deepen or dilute our expertise?',
        'Does it make the company easier or harder to understand?',
        'Would we want this opportunity to become a larger part of the business?',
      ],
    },

    {
      type: 'heading',
      text: 'Brand strategy should influence operations',
    },
    ...
    {
      type: 'heading',
      text: 'Saying no makes creative decisions easier',
    },
    ...
    {
      type: 'heading',
      text: 'Boundaries make teams faster',
    },
...

    {
      type: 'list',
      items: [
        'Marketing can evaluate ideas against a defined audience and position.',
        'Sales can prioritize opportunities that reinforce the desired customer base.',
        'Product teams can assess whether new features support the core promise.',
        'Design teams can maintain a recognizable creative direction.',
        'Leadership can evaluate growth opportunities against long-term focus.',
      ],
    },

    {
      type: 'heading',
      text: 'The strategy should create a filter',
    },
    ...
    {
      type: 'heading',
      text: 'Not every no is permanent',
    },
    ...
    {
      type: 'heading',
      text: 'If everything fits, the strategy is too broad',
    },
