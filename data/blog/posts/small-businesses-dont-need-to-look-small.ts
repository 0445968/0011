...
export const smallBusinessesDontNeedToLookSmall: BlogPost = {
  id: 'business-06',

  slug: 'small-businesses-dont-need-to-look-small',

  title: 'Small Businesses Don’t Need to Look Small',
  ...
  cover:
    '/images/blog/small-businesses-dont-need-to-look-small.jpg',
  ...
  content: [
    ...
    {
      type: 'heading',
      text: 'Customers experience signals before they experience the company',
    },
    ...
    {
      type: 'heading',
      text: 'Looking established is not the same as pretending to be large',
    },
    ...
    {
      type: 'heading',
      text: 'Consistency creates the perception of maturity',
    },
...

    {
      type: 'list',
      items: [
        'The website explains the business clearly.',
        'The proposal feels connected to the brand.',
        'Emails use a consistent voice.',
        'Pricing and scope are presented confidently.',
        'Project communication follows a predictable process.',
        'The final work feels aligned with the expectations created at the beginning.',
      ],
    },
    ...
    {
      type: 'heading',
      text: 'Small businesses often have structural advantages',
    },
...

    {
      type: 'list',
      items: [
        'Customers may work directly with senior people.',
        'Decisions can happen faster.',
        'The company can adapt without navigating several layers of approval.',
        'Specialization can be deeper because the team is intentionally focused.',
        'The customer experience can feel more direct and personal.',
      ],
    },
    ...
    {
      type: 'heading',
      text: 'Language can accidentally make a company feel smaller',
    },
    ...
    {
      type: 'heading',
      text: 'Lead with capability, not company size',
    },
    ...
    {
      type: 'heading',
      text: 'Design can create confidence before the first conversation',
    },
...

    {
      type: 'list',
      items: [
        'Use a clear visual hierarchy instead of filling every available space.',
        'Keep typography and spacing consistent across pages.',
        'Present fewer, stronger examples of work.',
        'Use confident language instead of excessive qualification.',
        'Make the path to contacting or hiring the company obvious.',
        'Remove outdated pages and unfinished sections.',
      ],
    },

    {
      type: 'heading',
      text: 'Process is one of the strongest signals of scale',
    },
    ...
    {
      type: 'heading',
      text: 'You do not need enterprise complexity',
    },
    ...
    {
      type: 'heading',
      text: 'A focused business can look more credible than a large unfocused one',
    },
    ...
    {
      type: 'heading',
      text: 'Build the experience for where the business is going',
    },
